/*	@(#)large3.c	1.1 88/10/11 NFS Rev 2 Testsuite	*/
/*
	...
	for (i = 1; i < argc; i++) {
		if (*argv[i] == '-')
			...
			case 't':
				...
				continue;
			case 'f':
				fprintf(stderr, "cc: warning: -f option "
...
char *strspl(left, right) char *left, *right;
{
	char buf[BUFSIZ];
